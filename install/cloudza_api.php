...
$sql = ["DROP TABLE IF EXISTS `webset`;","CREATE TABLE `webset`(
  ...
  DEFAULT CHARSET = utf8;",
    "INSERT INTO webset (web_title, web_titleDesc, web_des, web_key, web_qq, web_beian, web_ban, web_page_nums) VALUES ('CloudZA-API', '一款开源的API系统', 'CloudZA-API，我们致力于为用户提供稳定、快速的免费API数据接口服务。','API,云之安,API内容管理,免费API', '2922619853', '京ICP备8888888号', '云之安', 10);",
    "CREATE TABLE `admin`(
