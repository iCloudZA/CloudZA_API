					...
					<div class="js-sidebar-scroll">
						<div class="content-side content-side-user px-0 py-0">
							<div class="smini-visible-block animated fadeIn px-2">
								<img class="img-avatar img-avatar32" src="https://api.test.zhian.pro/assets/images/users/avatar-1.jpg" alt="">
							</div>
							<div class="smini-hidden text-center mx-auto">
								<a class="img-link" href="./">
									<img class="img-avatar" src="https://api.test.zhian.pro/assets/images/users/avatar-1.jpg" alt="">
								</a>
							...
							<div class="dropdown-menu dropdown-menu-lg p-0" aria-labelledby="page-header-themes-dropdown">
								...
								<div class="p-3">
									<div class="row g-0 text-center">
										...
										<div class="col-2">
											<a class="text-elegance" data-toggle="theme" data-theme="../assets/css/themes/elegance.min-5.4.css" href="javascript:void(0)">
												<i class="fa fa-2x fa-circle"></i>
											</a>
										</div>
										<div class="col-2">
											<a class="text-pulse" data-toggle="theme" data-theme="../assets/css/themes/pulse.min-5.4.css" href="javascript:void(0)">
												<i class="fa fa-2x fa-circle"></i>
											</a>
										</div>
										<div class="col-2">
											<a class="text-flat" data-toggle="theme" data-theme="../assets/css/themes/flat.min-5.4.css" href="javascript:void(0)">
												<i class="fa fa-2x fa-circle"></i>
											</a>
										</div>
										<div class="col-2">
											<a class="text-corporate" data-toggle="theme" data-theme="../assets/css/themes/corporate.min-5.4.css" href="javascript:void(0)">
												<i class="fa fa-2x fa-circle"></i>
											</a>
										</div>
										<div class="col-2">
											<a class="text-earth" data-toggle="theme" data-theme="../assets/css/themes/earth.min-5.4.css" href="javascript:void(0)">
												<i class="fa fa-2x fa-circle"></i>
											</a>
										</div>
									</div>
					...
					<div class="space-x-1">
						<div class="dropdown d-inline-block">
							...
							<div class="dropdown-menu dropdown-menu-md dropdown-menu-end p-0" aria-labelledby="page-header-user-dropdown">
								...
								<div class="p-2">
									<a class="dropdown-item d-flex align-items-center justify-content-between space-x-1" data-pjax href="./?web_edit">
										<span>修改密码</span>
										<i class="fa fa-fw fa-wrench opacity-25"></i>
									</a>
									<div class="dropdown-divider"></div>
									<a class="dropdown-item d-flex align-items-center justify-content-between space-x-1" data-pjax href="./?action=logout">
										<span>退出登录</span>
