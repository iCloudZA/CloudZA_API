...
//$todayChampion = Db::query('SELECT name, COUNT(*) as count FROM api_count WHERE DATE(datetime) = CURDATE() GROUP BY name ORDER BY count DESC LIMIT 1;');
    ...
    <div class="col-6 col-xl-4">
        <a class="block block-rounded block-link-pop text-end" href="javascript:void(0)">
            <div class="block-content block-content-full d-sm-flex justify-content-between align-items-center border-black-op-b border-3">
                ...
                <div class="text-end">
                    <div class="fs-3 fw-semibold text-primary"><?php echo $apiCount ?><span class="fs-sm">个</span></div>
...
<!--                </div>-->
<!--                <div class="text-end">-->
<!--                    <div class="fs-3 fw-semibold text-earth"><span class="fs-lg">--><?php //echo $todayChampion[0]['name'] ?><!--</span></div>-->
    ...
    <div class="col-6 col-xl-4">
        <a class="block block-rounded block-link-pop text-end" href="javascript:void(0)">
            <div class="block-content block-content-full d-sm-flex justify-content-between align-items-center border-black-op-b border-3">
                ...
                <div class="text-end">
                    <div class="fs-3 fw-semibold text-elegance"><?php echo $apiCallCount; ?><span class="fs-sm">次</span></div>
    ...
    <div class="col-6 col-xl-4">
        <a class="block block-rounded block-link-pop text-end" href="javascript:void(0)">
            <div class="block-content block-content-full d-sm-flex justify-content-between align-items-center border-black-op-b border-3">
                ...
                <div class="text-end">
                    <div class="fs-3 fw-semibold text-pulse"><?php echo $today; ?><span class="fs-sm">次</span></div>
